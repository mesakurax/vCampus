...
public class MyButton extends JButton {
    ...
    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(4, 124, 59);
    private Color BUTTON_COLOR2 = new Color(14, 231, 3);
    ...
    //按下按钮时字体的默认颜色
    private Color BUTTON_FOREGROUND_COLOR1 = new Color(3, 1, 2);
    private Color BUTTON_FOREGROUND_COLOR2 = new Color(217, 8, 32);
    //默认字体
