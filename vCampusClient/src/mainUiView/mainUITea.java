...
public class mainUITea extends JFrame {
    ...
    public mainUITea(SocketHelper socketHelper, User userInfo) throws InterruptedException {
        ...
        pagePanel.add(new Teacher(userInfo,socketHelper),"p4");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                uu.setId("09021102");
                try {
                    new mainUITea(skhp,uu).setVisible(true);
