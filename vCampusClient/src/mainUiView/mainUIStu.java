...
import bankSystemView.userBankView;
import entity.User;
...
public class mainUIStu extends JFrame {
    ...
    public mainUIStu(SocketHelper socketHelper, User userInfo) throws InterruptedException {
        ...
        button4.setLocation(0,230);
        button5.setLocation(0,310);
        button6.setLocation(0,390);
        button7.setLocation(0,470);
        ...
        pagePanel.add(new all(socketHelper,userInfo),"p3");
        pagePanel.add(new Student(userInfo,socketHelper),"p4");
        pagePanel.add(new userBankView(socketHelper,userInfo),"p6");
        pagePanel.add(new userShopView(userInfo,socketHelper),"p5");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                uu.setId("09021102");
                try {
                    new mainUIStu(skhp,uu).setVisible(true);
