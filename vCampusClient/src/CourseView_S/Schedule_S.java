 ...
 * @author 13352
 */
public class Schedule_S extends JPanel {
    ...
    public Schedule_S(User user, SocketHelper socketHelper) {
        //beautify();
        initComponents();
    ...
    public void refresh()
    {
        ...
        CourseTable courseTable=model.ChooseDisplay(user);
        if(courseTable!=null) {
            ...
            while (it.hasNext()) {
                ...
                String info = "《" + course.getCrsName() + "》 " + course.getTeacherName() + " ";
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //======== scrollPane1 ========
            {
                ...
                CLASSTABLE.setFont(new Font("\u6977\u4f53", Font.BOLD, 22));
